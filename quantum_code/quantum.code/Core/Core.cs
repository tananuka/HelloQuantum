...
namespace Quantum {
  ...
  public unsafe partial class Frame : Core.FrameBase {
    ...
    public const int DumpFlag_AssetDBCheckums = 1 << 9;
...
namespace Quantum {
  ...
  public partial class SimulationConfig : AssetObject {
    ...
    [Flags]
    public enum ChecksumErrorFrameDumpFlags {
      None = 0,
    ...
    /// Additional 
    /// </summary>
    public ChecksumErrorFrameDumpFlags ChecksumErrorFrameDumpOptions;
  }
...
namespace Quantum {
  public unsafe partial class ChecksumErrorFrameDumpContext {
    ...
    public ChecksumErrorFrameDumpContext(QuantumGame game, Frame frame) {
      var options = game.Configurations.Simulation.ChecksumErrorFrameDumpOptions;

      SimulationConfig = game.Configurations.Simulation;

      // write checksums
      if ((options & SimulationConfig.ChecksumErrorFrameDumpFlags.SendAssetDBChecksums) == SimulationConfig.ChecksumErrorFrameDumpFlags.SendAssetDBChecksums) {
