        ...
        using (new EditorGUI.DisabledScope(!enabled || "m_Script" == property.propertyPath && property.depth == 0)) {
          if (isLayer) {
            ...
            if (OnDrawProperty != null) {
              ...
              bool reorderableList = false;
#if UNITY_2021_2_OR_NEWER
              reorderableList = property.isArray;
#elif UNITY_2020_3
              if (property.isArray) {
...
#endif
              var propertyRect = EditorGUILayout.GetControlRect(true, EditorGUI.GetPropertyHeight(property, reorderableList));
              ...
              if (property.isArray && fixedArrayAttribute?.MinLength == 0 && fixedArrayAttribute?.MaxLength == 1) {
                ...
                expanded = EditorGUI.PropertyField(propertyRect, property, guiContent, reorderableList);
              }
            }
