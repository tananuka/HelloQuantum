...
namespace Quantum.Editor {
  ...
  public class AssetBaseEditor : UnityEditor.Editor {
    ...
    public override void OnInspectorGUI() {
      ...
      CustomEditorsHelper.DrawDefaultInspector(serializedObject, new string[] { AssetBase.DefaultAssetObjectPropertyPath });
      ...
      using (new CustomEditorsHelper.BoxScope(headline)) {
        ...
        CustomEditorsHelper.DrawDefaultInspector(serializedObject, target.AssetObjectPropertyPath, new string[] { }, false);
      }
